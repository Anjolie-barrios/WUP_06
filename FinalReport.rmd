...
# Methods
]]do last? BIGBANG vs RACE, RACE vs DEGREE, BIGBANG vs DEGREE
...
colPerc(table4)
```
Blacks are exactly even, but 2/3 of the "other" races don't believe in the theory of evolution. White is also even.  
```{r}
...
```
```{r}
fisherXY(GSScsv$RACE,GSScsv$EVOLVED,confL=.9,printAll = T)
```
